# [Julio Mendoza](https://j1c1m1b1.github.io)
...
* Data, Sealed, Value, and Enum Classes
* Deconstruction
* Extensions
* Delegation
* Generics
...
* [Coroutines](https://kotlinlang.org/docs/reference/coroutines-overview.html), Structured Concurrency, and [Kotlin Flow](https://kotlinlang.org/docs/reference/coroutines/flow.html)
...
* [Retrofit](https://square.github.io/retrofit/) with [OkHttp](https://square.github.io/okhttp/) (especially with Kotlin
  Coroutines)
...
[Git](https://git-scm.com/), [Jenkins](https://jenkins.io/), [Sendbird](https://sendbird.com/), [Sentry](https://sentry.io/welcome/), [Kobiton](https://kobiton.com/), [Test IO](https://test.io/)

## 👨🏾‍💻 My impact on some apps

### [HSE](https://play.google.com/store/apps/details?id=de.hse24)

**September 2019 - Present**

* Lead the development team, discuss crucial product and architectural decisions, continuously refactored the code base to make the app comply with Modern Android Development (MAD) standards
* Helped develop the code styles used for the development of the app
...
* Developed the award-winning "Shake" feature, increasing the app's popularity and furthering the users' engagement with the app, and the company's overall
* Created and continuously update the CI/CD process for the app
...
* Introduced Bitrise to the company to have a streamlined delivery of our releases.
* Created a communication library to provide a proprietary controlled tool to communicate delivery people with customers
...
* Made decisions about architecture and team management to comply most efficiently with the client's goals and timelines.
...
* Added code quality by taking part in the code-reviewing policy.
...
* Enforced user engagement and learning by developing tutorials for the main screens within the Android application.
* Increased the number of users of the application by adjusting multiple views to be correctly displayed on tablets and other different device sizes.
...
* Improved the sales of the El Alcoholimetro liquor distribution store by 20% through the orchestration and development of a simple delivery mobile application.

## 👨🏾‍💼 Professional Experience

### [HSE](https://www.hse.de/) - Android Developer
...
* Took a leadership role, helping to make decisions about architecture, automatization, testing, and hiring new developers for the team.
* Propose new practices, cutting-edge technologies, and new Architectural patterns for the app re-implementation.
...
* Gave Java and Android training to Developers on the company’s Mauritius site
* A backup resource to resolve emergencies and development of urgent requirements presented in Android applications made for the Publicis Groupe agencies

### Imaginamos S.A.S. - Android Developer

**Bogotá, Colombia | May 2014 - July 2015**

* Developed multiple custom applications for several clients from Colombia and the rest of the world, like Diageo (Colombia), El Corte Inglés (Spain), and Motorola (Latin America); among others.
...
* Created and developed a web application, which enabled the storage of surveys captured by a mobile application; and displayed representative graphs for the area of the marketing of Lafayette using PHP, HTML, CSS3, JSON, and AS3.
...
* Development of a web application prototype for audit reports in the Audit division of Seguros Bolivar, in Java, using JSF and Flash AS3 scripts (for graphs).
